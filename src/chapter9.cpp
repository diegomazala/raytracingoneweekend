...
int main()
{
	...
	list[1] = new sphere(vec3f(0.f, 0.f, -1.f), 0.5f, new lambertian<float>(vec3f(0.1f, 0.2f, 0.5f)));
	list[2] = new sphere(vec3f(1.f, 0.f, -1.f), 0.5f, new metal<float>(vec3f(0.8f, 0.6f, 0.2f), 1.0f));
	list[3] = new sphere(vec3f(-1.f, 0.f, -1.f), -0.45f, new dielectric<float>(1.5f));
	...
	img.save("chapter9.jpg");

#ifdef _WIN32
	ShellExecute(0, 0, "chapter9.jpg", 0, 0, SW_SHOW);
#endif
